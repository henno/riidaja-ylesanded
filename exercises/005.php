    ...
    const textPairs = [
        {
            ...
            corrupted: "Klaviatuuri ja hiire hea koostöö on tööl väga oluline. Mõlemad head tööriistad täiendavad teineteist täielikult. Hiir sobib väga täpseteks valikuteks ja mugavaks navigeerimiseks. Hiire kiire topeltklõps valib terve sõna väga kiirelt. Klaviatuur on eriti kiire teksti sisestamiseks. Koos kasutades saavutad kõige parima tulemuse. Hiire kiire klõps valib menüüst sobiva käsu. Klaviatuur sisestab kõik andmed väga kiiresti. Mõlema hea valdamine tõstab efektiivsust märgatavalt. Tasakaalustatud kasutamine on alati võti. Igapäevases päevatöös mõlemad on väga hädavajalikud. Kogenud kasutaja lülitub nende vahel väga sujuvalt. Õige töövahendi valik säästab palju aega."
        },
        {
            ...
            corrupted: "Teksti redigeerimisel töötavad klaviatuur ja hiir hästi koos. Hiir liigutab kursorit väga täpselt õigesse kohta. Klaviatuur sisestab või muudab kogu teksti. Hiire kiire valik märgib teksti osa. Hiire topeltklõpsuga aktiveerid sõna väga hetkega. Klaviatuuri erinevad klahvid vormindavad seda. Ctrl+klahvid kombineeritakse hiire kõikide tegevustega. Hiire kiire rullimisega liigud dokumendis. Klaviatuuri nooled täpsustavad positsiooni täpselt. Mõlemad on väga vajalikud tõhusaks töötamiseks. Hiire kiire lohistamine liigutab teksti lõike. Klaviatuuriga saab teksti struktuuri täielikult muuta. Koostoimes sünnib väga kiire ja täpne töö."
        },
        {
            ...
            corrupted: "Programmeerijad kombineerivad klaviatuuri ja hiirt hästi. Hiir navigeerib koodi keerulises struktuuris. Klaviatuur kirjutab kõik koodi read. Hiire kiire klõps avab faile ja erinevaid funktsioone. Hiire topeltklõps valib muutuja või funktsiooni täpse nime. Klaviatuuri kiirklahvid täidavad kõik käske. Debug režiimis hiir seab täpsed murrangupunkte. Klaviatuur juhib programmi täitmist täpselt. Mõlema väga oskuslik kasutus on oluline. Koostöö suurendab arenduskiirust märgatavalt. Hiir valib täpselt ridu refaktoreerimiseks. Klaviatuur teeb kõik koodimuudatusi automaatselt. Mõlema hea kombinatsioon teeb arenduse väga produktiivseks."
        },
        {
            ...
            corrupted: "Andmesisestuses on mõlemad head tööriistad väga kasulikud. Hiir valib täpselt väljad ja erinevad menüüd. Klaviatuur sisestab kõik numbrid ja teksti. Hiire kiire lohistamine kopeerib andmeid. Hiire topeltklõps aktiveerib lahtri sisu väga kiiresti. Klaviatuuri Tab klahv liigub väljade vahel kiiresti. Hiire kiire topeltklõps avab kirjeid. Klaviatuuri Enter kinnitab sisestuse täielikult. Mõlema hea kombinatsioon kiirendab tööd märgatavalt. Suur efektiivsus tuleneb koostööst. Hiir valib täpselt andmeväljasid kontekstist. Klaviatuur täidab vormid kõikide numbritega. Heas koostoimes toimub andmesisestus väga sujuvalt."
        },
        {
