...
$roundConfig = getExerciseRoundConfig('009', [
    1 => ['required_wpm' => 24, 'required_accuracy' => 90, 'time_limit' => 30],
    2 => ['required_wpm' => 28, 'required_accuracy' => 90, 'time_limit' => 30],
    3 => ['required_wpm' => 32, 'required_accuracy' => 90, 'time_limit' => 30],
]);
?>
...
<p>Raund <?= $roundConfig['round'] ?> / 3. Pimekirjutamise harjutus. Kirjuta ekraanil kuvatavad sõnad võimalikult kiiresti ja täpselt. Sul on aega <?= $roundConfig['time_limit'] ?> sekundit.</p>
...
<script>
    ...
    function endTest() {
        ...
        resultLevel.textContent = 'Ülesanne 009';
